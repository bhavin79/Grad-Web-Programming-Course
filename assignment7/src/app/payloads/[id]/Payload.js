...
export const Payload = ({payloadData})=>{
    ...
    let customerExist = data.customers.length>0;
    let nationalitiesExist = data.nationalities.length>0;
    let manufacturerExist =data.manufacturers.length>0;
    return (
        <article>
            {data&& <div className="payloadContainer">
                ...
                <div className="payloadQuickStats">
                    ...
                    <span> <Link href = {`/launches/${data.launch}`}>Launch</Link></span>
                </div>
